...
class Huffman2
{
    ...
    public static void buildHuffmanTree(String text)
    {
        ...
        //System.out.println("Amount of bits needed to encode after compression: " +codedBytesNeeded);
        System.out.println("Amount of bits needed to encode after compression: " +sb.length());
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("The number of bits needed to encode:"+text.length()*8);
